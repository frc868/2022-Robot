...
public class Drivetrain {
    ...
    public void driveArc(double targetLeft, double targetRight, double leftMaxSpeed, double rightMaxSpeed,
    ...
    public void goToTarget() {
        double calcSpeed = -drivePID.calculate(Robot.limelight.getDistance(), 5.3);
        setSpeed(calcSpeed);
    }
