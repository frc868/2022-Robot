...
public class Climber {
    ...
    /**
    * Constructor of class Climber. Used to instantiate the Climber class. Should only be used in getInstance method.
    */
    private Climber() {
    ...
    /**
    * Creates a Singleton for class Climber. Use this whenever Climber and it's methods need to be accessed
