...
public class Shooter {
    ...
    /**
    * Constructor of class Shooter. Used to instantiate the Shooter class. Should only be used in getInstance method.
    */
    private Shooter(){
        ...
        shooter_pid = new PIDController(RobotMap.PID_CONSTANTS.SHOOTER_CONSTANTS.SHOOTER_PID.KP, RobotMap.PID_CONSTANTS.SHOOTER_CONSTANTS.SHOOTER_PID.KI, RobotMap.PID_CONSTANTS.SHOOTER_CONSTANTS.SHOOTER_PID.KD);
    ...
    /**
    * Creates a Singleton for class Shooter. Use this whenever Shooter and it's methods need to be accessed
